...
void sct_read_rms(void* param) {
  ...
  for(;;) {
    ...
    display.display();
    Serial.println(String(rms_display) + " " + String(power_display));
...
void setup() {
  ...
  xTaskCreate(sct_read_rms, "SCT reading", 2*1024, NULL, 10, NULL);
}
